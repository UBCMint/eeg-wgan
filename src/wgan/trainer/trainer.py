...
from wgan.trainer.lr_scheduler import LRScheduler
from wgan.utils.logger import Logger, MetricLog
from wgan.utils.utils import load_from_json, write_to_json
...
class Trainer:
    ...
    Attributes:
        ...
        save_steps (int): Number of training steps before checkpointing.
    """
    def __init__(self,
                 netD,
                 netG,
